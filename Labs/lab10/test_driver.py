...
We assume the test program is called addone.py, and we import all the
functions in your program. When you develop your own lab10 modules, 
make sure any other code in your lab10.py file is under the 
...
comments. When you run 'test_driver.py', it imports 'addone' 
...
'doctest.testmod(lab10)' and uncomment the line 
'doctest.testmod(lab10, verbose=True)' underneath it. 
